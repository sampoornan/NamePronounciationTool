...
using NamePronunciation.Data;
using NamePronunciation.Data.Implementation;
...
namespace NamePronunciation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            this.RegisterConnectionSources(services);
        ...
        {
            var contextstring = Configuration.GetConnectionString("DBConnection");
